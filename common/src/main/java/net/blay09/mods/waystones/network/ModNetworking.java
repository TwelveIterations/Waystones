...
public class ModNetworking {
    ...
    public static void initialize(BalmNetworking networking) {
        ...
        networking.registerServerboundPacket(ServerboundEditWaystoneGroupPacket.TYPE, ServerboundEditWaystoneGroupPacket.class, ServerboundEditWaystoneGroupPacket.STREAM_CODEC, ServerboundEditWaystoneGroupPacket::handle);
        ...
        networking.registerServerboundPacket(ServerboundSortWaystoneGroupPacket.TYPE, ServerboundSortWaystoneGroupPacket.class, ServerboundSortWaystoneGroupPacket.STREAM_CODEC, ServerboundSortWaystoneGroupPacket::handle);
        ...
        networking.registerServerboundPacket(ServerboundRemoveWaystoneGroupPacket.TYPE, ServerboundRemoveWaystoneGroupPacket.class, ServerboundRemoveWaystoneGroupPacket.STREAM_CODEC, ServerboundRemoveWaystoneGroupPacket::handle);
        ...
        networking.registerClientboundPacket(ClientboundEpitaphActivationPacket.TYPE, ClientboundEpitaphActivationPacket.class, ClientboundEpitaphActivationPacket.STREAM_CODEC, ClientboundEpitaphActivationPacket::handle);
    }
