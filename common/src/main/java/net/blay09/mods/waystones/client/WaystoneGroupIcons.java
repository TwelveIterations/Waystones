...
public class WaystoneGroupIcons {
    ...
    public static Identifier getIcon(WaystoneGroup group) {
    ...
    public static List<Identifier> getPresetIcons() {
    ...
    private static Identifier toSpriteLocation(Identifier resource) {
