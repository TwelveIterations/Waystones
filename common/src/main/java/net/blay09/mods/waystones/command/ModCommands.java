...
public class ModCommands {
    ...
    private static final Identifier PERMISSION_WAYSTONES_COOLDOWN = Identifier.fromNamespaceAndPath(Waystones.MOD_ID, "command.waystones.cooldown");
    private static final Identifier PERMISSION_WAYSTONES_TWINBOUND = Identifier.fromNamespaceAndPath(Waystones.MOD_ID, "command.waystones.twinbound");
    ...
    public static void initialize(BalmCommands commands) {
        ...
        BalmCommands.registerPermission(PERMISSION_WAYSTONES_COOLDOWN, Permissions.COMMANDS_GAMEMASTER);
        BalmCommands.registerPermission(PERMISSION_WAYSTONES_TWINBOUND, Permissions.COMMANDS_GAMEMASTER);
    ...
    private static ItemStack createTwinboundFeather(ServerPlayer player) {
        ...
        final var itemStack = new ItemStack(ModItems.twinboundFeather.asItem());
