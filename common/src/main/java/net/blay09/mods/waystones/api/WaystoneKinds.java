...
public class WaystoneKinds {
    ...
    public static final Identifier FLEETING_MEMORIAL = Identifier.fromNamespaceAndPath("waystones", "fleeting_memorial");
    public static final Identifier TWINBOUND_FEATHER = Identifier.fromNamespaceAndPath("waystones", "twinbound_feather");
