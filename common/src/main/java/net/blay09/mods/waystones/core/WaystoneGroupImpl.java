...
public record WaystoneGroupImpl(ResourceLocation identifier, Component name, ResourceLocation icon, int color, boolean inbuilt, boolean hidden) implements WaystoneGroup {
