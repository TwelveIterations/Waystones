...
public class ModBlockEntities {
    ...
    public static Holder<BlockEntityType<FleetingMemorialBlockEntity>> fleetingMemorial;
    ...
    public static void initialize(BalmBlockEntityTypeRegistrar blockEntities) {
        ...
        fleetingMemorial = blockEntities.register("fleeting_memorial", FleetingMemorialBlockEntity::new, ModBlocks.fleetingMemorial).asHolder();
